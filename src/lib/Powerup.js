...
export default class Powerup
{
	 ...
	 *
	 * @returns {Powerup.Preset[keyof typeof Powerup.Preset]} The preset
	 */
	getPreset()
	{return (this._update.preset ?? this._data.preset)}
