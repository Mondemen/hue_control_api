 ...
 *
 * @callback PaletteColorEvent
 * @param {number} i - Index position of color in array
 * @param {Color} color - The color
 *
 * @callback PaletteColorXYEvent
 * @param {number} i - Index position of color in array
 * @param {XYValue} color - The color in XY format
 *
 * @callback PaletteColorBrightnessEvent
 * @param {number} i - Index position of color in array
 * @param {number} brightness - The brightness
 *
 * @callback PaletteColorTemperatureEvent
 * @param {number} i - Index position of mired in array
 * @param {Mired} mired - The mired
 *
 * @callback PaletteColorTemperatureMiredEvent
 * @param {number} i - Index position of mired in array
 * @param {number} mired - The mired in mired format
 *
 * @callback PaletteColorTemperatureBrightnessEvent
 * @param {number} i - Index position of mired in array
 * @param {number} brightness - The brightness
 *
 * @callback PaletteBrightnessEvent
 * @param {number} i - Index position of mired in array
 * @param {number} brightness - The brightness
 *
 * @callback PaletteEvent
 *
 * @callback SpeedEvent
		...
		if (data?.palette?.color || data?.palette?.color_temperature || data?.palette?.dimming)
		{
			...
			data?.palette?.color?.forEach((color, i) =>
			{
				...
				if (emit["color"])
				{
					...
					this._scene.emit("palette_color_xy", i, color.color.xy);
				}
			...
			data?.palette?.color_temperature?.forEach((color_temp, i) =>
			{
				...
				if (emit["color_temperature"])
				{
					...
					this._scene.emit("palette_color_temperature_mired", i, color_temp.color_temperature.mirek);
				}
